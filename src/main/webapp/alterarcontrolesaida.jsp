...
<body>
    ...
    <div class="container">
		<div class="row">
			<div class="cold-md-7">				
					<h3 style="color: #0B5ED7; text-decoration: underline; text-align:center; font-weight:700; text-transform: uppercase; padding-top:20px">Formulário Alterar Controle Saida Produtos</h3>	
				<hr>
				...
				<div class="row">                           
                            ...
                            <div class="col-sm-12 col-md-6">                               
                                  <div class="mb-3 col-md-8">
                                    <label for="alterarestoque" style="color:#0B5ED7; font-weight:700;" class="form-label">Estoque:</label>	
					        ...
					        <input type="text" class="form-control" id="alterarcodproduto" name="idprodutocontrolesaida" value="<%= saidaAlterar.getProdutos() %>" />                                    
                                      </div>
                                      </div>
                                      <div class="mb-3 col-md-8">
                                        <label for="alterardatasaida" style="color:#0B5ED7; font-weight:700;" class="form-label">Data Saída:</label>	
