...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="cadastrofuncionario.jsp"><img id="logo" src="img/Logo.png" width="130" height="90"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form action="listarfuncionarios.jsp" class="d-flex">    
         <div class="search">
        <div class="icon"></div>
        <div class="input">
...
<div class="container">
		<div class="row">
			<div class="cold-md-7">				
					<h3 style="color: #0B5ED7; text-decoration: underline; text-align:center; font-weight:700; text-transform: uppercase; padding-top:20px">Cadastro de Funcionários</h3>	
				<hr>
					<form method="post" action="FuncionariosServlet">
                        <div class="row">                           
                            <div class="col-sm-12 col-md-6">
                                <fieldset class="row">
                                    ...
                                    <input type ="text" name="nomefuncionario" maxlength="50" class="form-control" id="floatingInput1" required> 
                                </div>
                                <div class="mb-3">
                                  <label for="txtCpf" class="form-label" style="color:#0B5ED7; font-weight:700; ">CPF:</label>
                                  <input type ="text" name="cpffuncionario" class="form-control" id="txtCpf" required>                                      
                              </div>                                
                                </fieldset>                                   
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <fieldset class="row">
                                  ...
                                  <div class="mb-3 col-md-8">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        <label for="txtSexo" class="form-label" style="color:#0B5ED7; font-weight:700; ">Sexo:</label>
                                        <div class="input-group">
                                            <input type ="text" name="sexofuncionario" maxlength="50" class="form-control" id="txtSexo">                                    
                                      </div>
                                      </div>
                                      <div class="mb-3 col-md-10">
                                        <label for="txtTelefone" class="form-label" style="color:#0B5ED7; font-weight:700; ">Telefone:</label>
                                        <input type ="text" name="telefonefuncionario" maxlength="50" class="form-control" id="txtTelefone" required> 
                                    </div>
                                        <div class=" mb-3 col-md-8">
