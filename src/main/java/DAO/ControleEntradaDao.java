...
public class ControleEntradaDao extends Conexao {
	public void cadastrar(ControleEntrada entrada) {
		...
		String sql = "insert into controle_entrada " + "(quantidadeEntrada, dataEntrada, valorProduto, nomeProdutoEntrada, idProduto, idfornecedor) values "
				+ "( ?, ?, ?, ?, ?, ?)";
		...
		public void alterar(ControleEntrada entrada) {
			String sql = "update controle_entrada set " + "quantidadeEntrada = ?, " + "dataEntrada = ?, " + "valorProduto = ?, "
					+ "nomeProdutoEntrada = ?, " + "idProduto = ?, " + "idfornecedor = ? " + "where idEntrada =? ";
